...
def check_primary_key(file_name: str, primary_key: str, engine: sql.engine.Engine, **kwargs):
    ...
    ), f"The file {file_name} violates the primary key constraint of {table_name}"


def check_foreign_keys(file_name: str, foreign_keys: Any, engine: sql.engine.Engine, **kwargs):
    data_path = kwargs["ti"].xcom_pull(key=file_name, task_ids="files_sensor")
...
with DAG(
    ...
    t_files_sensor = PythonOperator(
        ...
        op_kwargs={"bucket_name": "test", "client": client},
    )
    ...
    cpk_geolocations = PythonOperator(
        ...
        provide_context=True,
        op_kwargs={"file_name": "geolocations.csv", "primary_key": "zip_code", "engine": engine},
    )
    ...
    l_geolocations = PythonOperator(
        ...
        provide_context=True,
        op_kwargs={"file_name": "geolocations.csv", "engine": engine},
    )
    ...
    cpk_customers = PythonOperator(
        ...
        python_callable=check_primary_key,
        provide_context=True,
        op_kwargs={"file_name": "customers.csv", "primary_key": "customer_id", "engine": engine},
    )
    ...
    l_customers = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "customers.csv", "engine": engine},
    )
    ...
    cpk_sellers = PythonOperator(
        ...
        python_callable=check_primary_key,
        provide_context=True,
        op_kwargs={"file_name": "sellers.csv", "primary_key": "seller_id", "engine": engine},
    )
    ...
    l_sellers = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "sellers.csv", "engine": engine},
    )
    ...
    cpk_products = PythonOperator(
        ...
        python_callable=check_primary_key,
        provide_context=True,
        op_kwargs={"file_name": "products.csv", "primary_key": "product_id", "engine": engine},
    )
    ...
    l_products = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "products.csv", "engine": engine},
    )
    ...
    l_marketing_qualified_leads = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "marketing_qualified_leads.csv", "engine": engine},
    )
    ...
    l_closed_deals = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "closed_deals.csv", "engine": engine},
    )
    ...
    cpk_orders = PythonOperator(
        ...
        python_callable=check_primary_key,
        provide_context=True,
        op_kwargs={"file_name": "orders.csv", "primary_key": "order_id", "engine": engine},
    )
    ...
    l_orders = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "orders.csv", "engine": engine},
    )
    ...
    l_order_items = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "order_items.csv", "engine": engine},
    )
    ...
    l_order_payments = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "order_payments.csv", "engine": engine},
    )
    ...
    l_order_reviews = PythonOperator(
        ...
        python_callable=load_data,
        provide_context=True,
        op_kwargs={"file_name": "order_reviews.csv", "engine": engine},
    )
