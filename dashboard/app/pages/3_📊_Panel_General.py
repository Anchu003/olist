...
st.title(":mag_right: Trực quan hóa dữ liệu tổng quan")
st.text("Dưới đây là kết quả tổng hợp của phân tích dữ liệu")
st.markdown("---")

st.sidebar.header("Bảng tổng quan")
st.sidebar.write(
    """Bảng tổng quan chứa thông tin về xu hướng doanh số theo thời gian, 
...
with tab_ventas:
    ...
    with col_ventas:
        ...
        fig = px.line(
            ...
            labels={"fecha": "Thời gian", "total": "Tổng doanh số"},
        )
    ...
    with col_categorias:
        ...
        fig = px.bar(
            ...
            x="categoria",
            y="total",
            title="Top 5 danh mục có doanh số cao nhất",
        )
        st.plotly_chart(fig, use_container_width=True)
...
with tab_clientes:
    ...
    with col_fig:
        fig = px.bar(
            ...
            x="estado",
            y="weight",
            title="Top 5 bang có nhiều khách hàng nhất",
            labels={"weight": "Số lượng khách hàng", "estado": "Bang"},
        )
        st.plotly_chart(fig, use_container_width=True)
...
with tab_vendedores:
    ...
    with col_fig:
        fig = px.bar(
            ...
            x="estado",
            y="weight",
            title="Top 5 bang có nhiều người bán nhất",
            labels={"weight": "Số lượng người bán", "estado": "Bang"},
        )
        st.plotly_chart(fig, use_container_width=True)
